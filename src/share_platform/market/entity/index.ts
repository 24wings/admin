...
import { AccountTypeEnum, AccountStatusEnum, OrderTypeEnum, MsgTypeEnum, PriceUnitEnum, CustCardStatusEnum, CustomerStatusEnum, CreateWayEnum, CertificateWayEnum, OrderStatusEnum, PayTypeEnum, MemberTypeEnum, CommonStatusEnum, PriceWayEnum } from "../enum";
...
export class Order {
    ...
    creatorId?: number;//创建人Id
    creator?: string;//创建人
    cardNo?: string;//冗余字段cardNo
    payPassword?: string;//冗余字段
    actTime?: Date;//结算时间
